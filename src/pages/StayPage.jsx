      ...
      <section className="flex flex-col items-center gap-5 mt-16 font-['Montserrat']">
        <div className="flex justify-between gap-3 items-center flex-wrap w-[90vw] max-w-[1136px]">
          <div className="flex flex-col gap-3">
            <h1 className="font-semibold text-[32px]">Our Suggestions</h1>
            <div className="flex justify-between items-center gap-[16px] flex-wrap max-w-[1136px] w-[90vw]">
              {[
                ...
                <div
                  key={index}
                  className="bg-white w-[250px] rounded-lg flex items-center justify-between gap-[16px] mx-auto p-[4px]"
                >
